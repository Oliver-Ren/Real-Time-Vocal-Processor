start_gui
create_project audio ../pro_audio -part xc7z020clg484-1 -force
...
startgroup
set_property -dict [list CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {10.000000} CONFIG.PCW_EN_CLK1_PORT {1} CONFIG.PCW_I2C1_PERIPHERAL_ENABLE {1}] [get_bd_cells processing_system7_0]
endgroup
startgroup
set_property -dict [list CONFIG.PCW_TTC0_CLK0_PERIPHERAL_CLKSRC {External} CONFIG.PCW_TTC0_CLK1_PERIPHERAL_CLKSRC {External} CONFIG.PCW_TTC0_CLK2_PERIPHERAL_CLKSRC {External}] [get_bd_cells processing_system7_0]
endgroup
