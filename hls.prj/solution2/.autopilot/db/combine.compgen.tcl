...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    reset_level 1 \
    sync_rst true \
    corename input_array_V \
    op interface \
    ports { input_array_V_address0 { O 10 vector } input_array_V_ce0 { O 1 bit } input_array_V_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_array_V'"
}
}
