...
set C_modelArgList { 
	...
	{ phaseFrame_V int 26 regular {array 1024 { 0 0 } 1 1 }  }
...
set portList { 
	...
	{ phaseFrame_V_d0 sc_out sc_lv 26 signal 1 } 
	...
	{ phaseFrame_V_d1 sc_out sc_lv 26 signal 1 } 
...
set Spec2ImplPortList { 
	...
	phaseFrame_V { ap_memory {  { phaseFrame_V_address0 mem_address 1 10 }  { phaseFrame_V_ce0 mem_ce 1 1 }  { phaseFrame_V_we0 mem_we 1 1 }  { phaseFrame_V_d0 mem_din 1 26 }  { phaseFrame_V_address1 mem_address 1 10 }  { phaseFrame_V_ce1 mem_ce 1 1 }  { phaseFrame_V_we1 mem_we 1 1 }  { phaseFrame_V_d1 mem_din 1 26 } } }
