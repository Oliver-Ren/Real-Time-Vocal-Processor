...
#ifndef _interp1_dx_V_H_
#define _interp1_dx_V_H_
...
struct interp1_dx_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(interp1_dx_V_core);
    interp1_dx_V_core(sc_core::sc_module_name) {
...
SC_MODULE( interp1_dx_V )
{
    ...
    SC_CTOR( interp1_dx_V ) {
        meminst = new interp1_dx_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    interp1_dx_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_interp1_dx_V_H_
