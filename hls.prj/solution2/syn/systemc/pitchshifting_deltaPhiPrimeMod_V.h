...
#define _pitchshifting_deltaPhiPrimeMod_V_H_
...
struct pitchshifting_deltaPhiPrimeMod_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(pitchshifting_deltaPhiPrimeMod_V_core);
    pitchshifting_deltaPhiPrimeMod_V_core(sc_core::sc_module_name) {
    ...
    ~pitchshifting_deltaPhiPrimeMod_V_core() {
        delete [] mem;
    }
...
SC_MODULE( pitchshifting_deltaPhiPrimeMod_V )
{
    ...
    SC_CTOR( pitchshifting_deltaPhiPrimeMod_V ) {
        meminst = new pitchshifting_deltaPhiPrimeMod_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
