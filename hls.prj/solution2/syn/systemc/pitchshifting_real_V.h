...
#ifndef _pitchshifting_real_V_H_
#define _pitchshifting_real_V_H_
...
struct pitchshifting_real_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(pitchshifting_real_V_core);
    pitchshifting_real_V_core(sc_core::sc_module_name) {
...
SC_MODULE( pitchshifting_real_V )
{
    ...
    SC_CTOR( pitchshifting_real_V ) {
        meminst = new pitchshifting_real_V_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    pitchshifting_real_V_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_pitchshifting_real_V_H_
