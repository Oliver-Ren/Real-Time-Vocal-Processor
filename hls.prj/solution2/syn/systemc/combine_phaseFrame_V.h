...
#ifndef _combine_phaseFrame_V_H_
#define _combine_phaseFrame_V_H_
...
struct combine_phaseFrame_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(combine_phaseFrame_V_core);
    combine_phaseFrame_V_core(sc_core::sc_module_name) {
...
SC_MODULE( combine_phaseFrame_V )
{
    ...
    SC_CTOR( combine_phaseFrame_V ) {
        meminst = new combine_phaseFrame_V_core <1, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    combine_phaseFrame_V_core <1, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_combine_phaseFrame_V_H_
