...
#ifndef _top_transfer_array_V_H_
#define _top_transfer_array_V_H_
...
struct top_transfer_array_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(top_transfer_array_V_core);
    top_transfer_array_V_core(sc_core::sc_module_name) {
...
SC_MODULE( top_transfer_array_V )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 323;
    ...
    SC_CTOR( top_transfer_array_V ) {
        meminst = new top_transfer_array_V_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    top_transfer_array_V_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_top_transfer_array_V_H_
