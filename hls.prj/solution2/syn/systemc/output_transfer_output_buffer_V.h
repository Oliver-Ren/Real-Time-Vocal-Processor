...
#ifndef _output_transfer_output_buffer_V_H_
#define _output_transfer_output_buffer_V_H_
...
struct output_transfer_output_buffer_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(output_transfer_output_buffer_V_core);
    output_transfer_output_buffer_V_core(sc_core::sc_module_name) {
    ...
    ~output_transfer_output_buffer_V_core() {
        delete [] mem;
    }
...
SC_MODULE( output_transfer_output_buffer_V )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 1993;
    ...
    SC_CTOR( output_transfer_output_buffer_V ) {
        meminst = new output_transfer_output_buffer_V_core <1, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    output_transfer_output_buffer_V_core <1, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_output_transfer_output_buffer_V_H_
