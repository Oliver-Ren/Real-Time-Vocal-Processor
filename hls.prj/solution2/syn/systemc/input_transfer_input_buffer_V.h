...
#ifndef _input_transfer_input_buffer_V_H_
#define _input_transfer_input_buffer_V_H_
...
struct input_transfer_input_buffer_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(input_transfer_input_buffer_V_core);
    input_transfer_input_buffer_V_core(sc_core::sc_module_name) {
    ...
    ~input_transfer_input_buffer_V_core() {
        delete [] mem;
    }
...
SC_MODULE( input_transfer_input_buffer_V )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 1280;
    ...
    SC_CTOR( input_transfer_input_buffer_V ) {
        meminst = new input_transfer_input_buffer_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    input_transfer_input_buffer_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_input_transfer_input_buffer_V_H_
