...
#ifndef __combine_mul_40ns_20ns_60_4__HH__
#define __combine_mul_40ns_20ns_60_4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(combine_mul_40ns_20ns_60_4) {
    ...
    SC_CTOR(combine_mul_40ns_20ns_60_4):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
