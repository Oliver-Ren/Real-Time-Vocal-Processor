...
#ifndef _combine_time_domain_V_H_
#define _combine_time_domain_V_H_
...
struct combine_time_domain_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(combine_time_domain_V_core);
    combine_time_domain_V_core(sc_core::sc_module_name) {
...
SC_MODULE( combine_time_domain_V )
{
    ...
    SC_CTOR( combine_time_domain_V ) {
        meminst = new combine_time_domain_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    combine_time_domain_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_combine_time_domain_V_H_
