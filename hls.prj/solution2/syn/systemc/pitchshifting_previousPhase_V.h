...
#ifndef _pitchshifting_previousPhase_V_H_
#define _pitchshifting_previousPhase_V_H_
...
struct pitchshifting_previousPhase_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(pitchshifting_previousPhase_V_core);
    pitchshifting_previousPhase_V_core(sc_core::sc_module_name) {
    ...
    ~pitchshifting_previousPhase_V_core() {
        delete [] mem;
    }
...
SC_MODULE( pitchshifting_previousPhase_V )
{
    ...
    SC_CTOR( pitchshifting_previousPhase_V ) {
        meminst = new pitchshifting_previousPhase_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    pitchshifting_previousPhase_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_pitchshifting_previousPhase_V_H_
