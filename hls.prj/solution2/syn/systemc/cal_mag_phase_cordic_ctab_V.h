...
#ifndef _cal_mag_phase_cordic_ctab_V_H_
#define _cal_mag_phase_cordic_ctab_V_H_
...
struct cal_mag_phase_cordic_ctab_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(cal_mag_phase_cordic_ctab_V_core);
    cal_mag_phase_cordic_ctab_V_core(sc_core::sc_module_name) {
        ...
        mem[0] = "11001001000011111101";
        mem[1] = "01110110101100011001";
        mem[2] = "00111110101101101110";
        mem[3] = "00011111110101011011";
        mem[4] = "00001111111110101010";
        mem[5] = "00000111111111110101";
        mem[6] = "00000011111111111110";
        mem[7] = "00000001111111111111";
        mem[8] = "00000000111111111111";
        mem[9] = "00000000011111111111";
        mem[10] = "00000000001111111111";
        mem[11] = "00000000000111111111";
        mem[12] = "00000000000011111111";
        mem[13] = "00000000000001111111";
        mem[14] = "00000000000000111111";
        mem[15] = "00000000000000011111";
        mem[16] = "00000000000000001111";
        mem[17] = "00000000000000000111";
        mem[18] = "00000000000000000011";
        mem[19] = "00000000000000000001";
        for (unsigned i = 20; i < 64 ; i = i + 1) {
            mem[i] = "00000000000000000000";
        }
    }
    ...
    ~cal_mag_phase_cordic_ctab_V_core() {
        delete [] mem;
    }
...
SC_MODULE( cal_mag_phase_cordic_ctab_V )
{
    ...
    SC_CTOR( cal_mag_phase_cordic_ctab_V ) {
        meminst = new cal_mag_phase_cordic_ctab_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    cal_mag_phase_cordic_ctab_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_cal_mag_phase_cordic_ctab_V_H_
