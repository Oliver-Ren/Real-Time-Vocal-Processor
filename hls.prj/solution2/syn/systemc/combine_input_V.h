...
#ifndef _combine_input_V_H_
#define _combine_input_V_H_
...
struct combine_input_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(combine_input_V_core);
    combine_input_V_core(sc_core::sc_module_name) {
...
SC_MODULE( combine_input_V )
{
    ...
    SC_CTOR( combine_input_V ) {
        meminst = new combine_input_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    combine_input_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_combine_input_V_H_
