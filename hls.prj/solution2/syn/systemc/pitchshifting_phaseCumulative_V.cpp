...
void pitchshifting_phaseCumulative_V::proc_mem_q()
{
...
void pitchshifting_phaseCumulative_V::proc_mem_ra()
{
...
void pitchshifting_phaseCumulative_V::proc_mem_ce()
{
    sc_lv<1> tmp;
    tmp[0] = ce0.read();
    mem_ce.write(tmp);
...
void pitchshifting_phaseCumulative_V::proc_mem_wa()
{
    sc_lv<1 * AddressWidth> tmp;
    tmp = (address1.read());
    mem_wa.write(tmp);
...
void pitchshifting_phaseCumulative_V::proc_mem_we()
{
    sc_lv<1> tmp;
    tmp[0] = we1.read();
    mem_we.write(tmp);
...
void pitchshifting_phaseCumulative_V::proc_mem_d()
{
...
void pitchshifting_phaseCumulative_V::proc_op()
{
...
void pitchshifting_phaseCumulative_V::proc_addr()
{
...
// check collision
void pitchshifting_phaseCumulative_V::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
