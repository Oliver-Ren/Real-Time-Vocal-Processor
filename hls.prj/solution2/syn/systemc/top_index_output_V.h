...
#ifndef _top_index_output_V_H_
#define _top_index_output_V_H_
...
struct top_index_output_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(top_index_output_V_core);
    top_index_output_V_core(sc_core::sc_module_name) {
...
SC_MODULE( top_index_output_V )
{
    ...
    SC_CTOR( top_index_output_V ) {
        meminst = new top_index_output_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    top_index_output_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_top_index_output_V_H_
