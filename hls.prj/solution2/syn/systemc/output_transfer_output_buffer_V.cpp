...
void output_transfer_output_buffer_V::proc_mem_q()
{
...
void output_transfer_output_buffer_V::proc_mem_ra()
{
...
void output_transfer_output_buffer_V::proc_mem_ce()
{
    sc_lv<1> tmp;
    tmp[0] = ce0.read();
    mem_ce.write(tmp);
...
void output_transfer_output_buffer_V::proc_mem_wa()
{
...
void output_transfer_output_buffer_V::proc_mem_we()
{
    sc_lv<2> tmp;
    tmp[1] = we0.read();
    tmp[0] = we1.read();
...
void output_transfer_output_buffer_V::proc_mem_d()
{
...
void output_transfer_output_buffer_V::proc_op()
{
...
void output_transfer_output_buffer_V::proc_addr()
{
...
// check collision
void output_transfer_output_buffer_V::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
