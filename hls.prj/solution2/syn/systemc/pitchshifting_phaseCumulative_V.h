...
#ifndef _pitchshifting_phaseCumulative_V_H_
#define _pitchshifting_phaseCumulative_V_H_
...
struct pitchshifting_phaseCumulative_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(pitchshifting_phaseCumulative_V_core);
    pitchshifting_phaseCumulative_V_core(sc_core::sc_module_name) {
    ...
    ~pitchshifting_phaseCumulative_V_core() {
        delete [] mem;
    }
...
SC_MODULE( pitchshifting_phaseCumulative_V )
{
    ...
    SC_CTOR( pitchshifting_phaseCumulative_V ) {
        meminst = new pitchshifting_phaseCumulative_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    pitchshifting_phaseCumulative_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_pitchshifting_phaseCumulative_V_H_
