...
#ifndef _FFT_wreal_V_H_
#define _FFT_wreal_V_H_
...
struct FFT_wreal_V_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(FFT_wreal_V_core);
    FFT_wreal_V_core(sc_core::sc_module_name) {
...
SC_MODULE( FFT_wreal_V )
{
    ...
    SC_CTOR( FFT_wreal_V ) {
        meminst = new FFT_wreal_V_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    FFT_wreal_V_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_FFT_wreal_V_H_
