...
architecture behav of bitrp is 
    ...
    signal tmp_20_fu_191_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_21_fu_197_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_115_fu_156_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_116_fu_160_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st3_fsm_2 = ap_CS_fsm) and not((exitcond2_fu_144_p2 = ap_const_lv1_0)) and not((ap_const_lv1_0 = tmp_fu_186_p2)))) then
                ximag_V_addr_4_reg_256 <= tmp_21_fu_197_p1(10 - 1 downto 0);
                ximag_V_addr_reg_250 <= tmp_20_fu_191_p1(10 - 1 downto 0);
                xreal_V_addr_4_reg_245 <= tmp_21_fu_197_p1(10 - 1 downto 0);
                xreal_V_addr_reg_239 <= tmp_20_fu_191_p1(10 - 1 downto 0);
            end if;
        end if;
    end process;
    ...
    b_1_fu_164_p3 <= (tmp_115_fu_156_p1 & tmp_116_fu_160_p1);
    ...
    tmp_115_fu_156_p1 <= b_reg_116(31 - 1 downto 0);
    tmp_116_fu_160_p1 <= a_reg_96(1 - 1 downto 0);
    tmp_20_fu_191_p1 <= std_logic_vector(resize(unsigned(b_reg_116),64));
    tmp_21_fu_197_p1 <= std_logic_vector(resize(unsigned(a_3_reg_82),64));
    ...
    ximag_V_address0_assign_proc : process(ap_CS_fsm, ximag_V_addr_reg_250, ximag_V_addr_4_reg_256, tmp_21_fu_197_p1)
    begin
        if ((ap_ST_st5_fsm_4 = ap_CS_fsm)) then 
            ...
            ximag_V_address0 <= tmp_21_fu_197_p1(10 - 1 downto 0);
        else 
            ximag_V_address0 <= ximag_V_addr_4_reg_256;
        end if; 
    end process;

    ximag_V_address1 <= tmp_20_fu_191_p1(10 - 1 downto 0);
    ...
    xreal_V_address0_assign_proc : process(ap_CS_fsm, xreal_V_addr_reg_239, xreal_V_addr_4_reg_245, tmp_21_fu_197_p1)
    begin
        if ((ap_ST_st5_fsm_4 = ap_CS_fsm)) then 
            ...
            xreal_V_address0 <= tmp_21_fu_197_p1(10 - 1 downto 0);
        else 
            xreal_V_address0 <= xreal_V_addr_4_reg_245;
        end if; 
    end process;

    xreal_V_address1 <= tmp_20_fu_191_p1(10 - 1 downto 0);
